...
const Campus = ({ dictionary }: Props) => {
  return (
    // <div className="mt-[112px] flex h-[522px] w-full  items-center  justify-center border-[4px] border-white">
    ...
    //           {dictionary.home.campus.campus}
    //         </Typography>
    //         <Typography variant="h4" className="uppercase">
    //           {dictionary.home.campus.ambassador}
    //         </Typography>
    //       </div>
